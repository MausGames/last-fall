...
void CoreApp::Setup()
{
    ...
    //Core::Manager::Resource->Load<coreShader>("default_3d_low_inst.vert", CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/default_3d_low.vert", CORE_SHADER_OPTION_INSTANCING);
    Core::Manager::Resource->Load<coreShader>("fullscreen.vert",    CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/fullscreen.vert");
    Core::Manager::Resource->Load<coreShader>("fullscreen.frag",    CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/fullscreen.frag");
    Core::Manager::Resource->Load<coreShader>("object_door.vert",   CORE_RESOURCE_UPDATE_MANUAL, "data/shaders/object_door.vert");
    ...
    //    ->AttachShader  (Core::Manager::Resource->Get <coreShader> ("default_3d_low_inst.vert"))
    //    ->AttachShader  (Core::Manager::Resource->Get <coreShader> ("tile_inst.frag"))
    //    ->Finish();
}