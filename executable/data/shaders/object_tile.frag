...
smooth varying vec2 v_v2Center;
smooth varying vec3 v_v3Normal;
...
void FragmentMain()
{
    ...
    vec3 v3Color1 = u_v4Color.rgb * mix(1.0, 0.45, coreSmoothStep(0.85, 0.89, max(abs(v_v2Center.x), abs(v_v2Center.y))));
